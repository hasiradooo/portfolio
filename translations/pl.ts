...
export const dict: TranslationDictionary = {
	common: {
		...
		readyToGetStarted: {
			...
			description:
				"Porozmawiajmy o Twoim projekcie i stwórzmy razem coś niesamowitego.",
	...
	prices: {
		title: "Cennik",
		description:
			"Oferuję przejrzyste opcje cenowe dostosowane do Twoich potrzeb. Niezależnie od tego, czy jesteś małą firmą, która dopiero zaczyna, czy dużym przedsiębiorstwem poszukującym kompleksowych rozwiązań, mam pakiety zaprojektowane, aby pomóc Ci odnieść sukces.",
		packages: {
			...
			basic: {
				...
				description:
					"Idealny dla małych firm potrzebujących czystej, prostej strony",
				features: [
					"Responsywny design",
					"Do 5 stron",
			...
			professional: {
				...
				price: "2499 zł",
				description:
					"Idealny dla rozwijających się firm o specyficznych potrzebach",
				features: [
		...
		customServices: {
			...
			uiUxDesign: {
				...
				services: [
					{
						name: "Projektowanie UI/UX stron internetowych",
						price: "90 zł/godz.",
					},
					{
						name: "Projektowanie UI/UX aplikacji mobilnych",
						price: "130 zł/godz.",
					},
					{ name: "Responsywne systemy projektowania", price: "150 zł/godz." },
					{
						name: "Biblioteka komponentów UI",
						price: "130 zł/godz.",
						originalPrice: "180 zł/godz.",
					},
				],
			},
			portfolioWebsites: {
				...
				services: [
					{
						name: "Portfolio One-Page (hero + 5-7 sekcji, lekka animacja)",
						price: "1999-2999 zł",
					},
					{ name: "Multi-Page (3-5 prostych stron)", price: "1499-2299 zł" },
					{
						name: "Premium (5+ stron, CMS/blog, tech SEO)",
						price: "od 3899 zł",
					},
			...
			items: [
				{
					...
					answer:
						"Zazwyczaj podstawowa strona zajmuje 2-3 tygodnie, profesjonalna strona 4-6 tygodni, a rozwiązania enterprise 8-12 tygodni. Harmonogram zależy od złożoności projektu i cykli informacji zwrotnej.",
				},
				{
					question: "Czy oferujesz plany utrzymania?",
					answer:
						"Tak, oferuję miesięczne plany utrzymania zaczynające się od 449 zł/miesiąc, które obejmują aktualizacje, poprawki bezpieczeństwa i drobne zmiany treści.",
				},
				{
					question: "Jakie metody płatności akceptujesz?",
					answer:
						"Akceptuję karty kredytowe, PayPal i przelewy bankowe. Projekty zazwyczaj wymagają 50% zaliczki z góry, a pozostała część jest płatna po zakończeniu.",
				},
				{
					question: "Czy mogę samodzielnie aktualizować stronę?",
					answer:
						"Oczywiście! Tworzę strony z przyjaznymi dla użytkownika systemami zarządzania treścią i zapewniam szkolenie, abyś mógł dokonywać aktualizacji samodzielnie.",
				},
			],
		},
		termsOfService: {
			...
			sections: {
				...
				unlimitedPages: {
					...
					description:
						'"Nieograniczona liczba stron" oznacza, że nie ma z góry określonego limitu w ramach normalnych potrzeb biznesowych dla szablonowych stron i tras. Nie oznacza to nieskończonej liczby stron lub nieograniczonego wprowadzania treści. Katalogi o dużej objętości, masywne blogi, masowe importy lub programowe generowanie stron mogą wymagać oddzielnego określenia zakresu, automatyzacji lub dodatkowych opłat. Wprowadzanie treści jest objęte w rozsądnym zakresie; bardzo duże ilości treści mogą być wyceniane oddzielnie.',
				},
			},
		},
		cta: {
			title: "Gotowy, aby zacząć?",
			description:
				"Skontaktuj się z nami już dziś, aby uzyskać bezpłatną konsultację i omówić, jak mogę ożywić Twoją wizję.",
	...
	about: {
		...
		bio: {
			intro:
				"Cześć! Jestem Kris German, {age}-letni projektant i programista z Polski. Rozpocząłem swoją przygodę z projektowaniem w 2016 roku i od tego czasu pasjonuję się tworzeniem pięknych, funkcjonalnych doświadczeń cyfrowych.",
			projects:
				"Na przestrzeni lat pracowałem nad różnymi projektami, od gier po aplikacje webowe. Uwielbiam odkrywać nowe technologie i przesuwać granice możliwości.",
		},
		experience: {
			label: "Doświadczenie",
			years: "Lat",
	...
	projects: {
		...
		cta: {
			...
			description:
				"Wesprzyj nas, aby otrzymać ekskluzywne aktualizacje i nagrody",
			patreon: "Patreon",
		...
		data: [
			{
				...
				description:
					"Nowoczesne i łatowe narzędzie dla artystów wszelkiego rodzaju.",
				category: ["webApps", "mobile"],
				status: ["inDevelopment", "concept"],
				technologies: ["TanStack", "React", "Tailwindcss", "E-commerce"],
				links: [
					{
						name: "Wkrótce",
						url: "#",
				...
				content: {
					about: ["Nowoczesne targowisko dla artystów wszelkiego rodzaju."],
					features: ["Wkrótce"],
				},
				details: {
			...
			},
			{
				...
				content: {
					about: [
						"Niestandardowa strona portfolio dla Zaczkie, prezentująca sztukę cyfrową i ilustracje.",
					],
					features: [
						"Galeria sztuki z kategoriami",
						"Informacje o zleceniach",
						"Bio artysty i kontakt",
					],
				},
				details: {
					role: "Web Developer",
			...
			},
			{
				...
				content: {
					about: [
						"Strona portfolio zaprojektowana dla artysty cyfrowego do prezentacji swoich prac i ilustracji.",
					],
					features: [
			...
			},
			{
				...
				links: [
					{
						name: "Dokumentacja Next.js",
						url: "https://nextjs.org/docs",
						description: "Framework napędzający Rabbit Hole",
					},
				],
				// thumbnail: {
				//   square: {
				...
				content: {
					about: [
						"RabbitHole to ekskluzywna platforma społecznościowa, gdzie artyści udostępniają treści w tematycznych społecznościach.",
					],
					features: [
						"Feed postów w układzie masonry/grid",
						"System podwójnych kont",
						"System kluczy zaproszeń",
					],
				},
				details: {
					role: "Full-Stack Developer",
					timeline: `${new Date().getFullYear()} - Obecnie`,
					platform: "Aplikacja Web",
				},
			},
			{
				slug: "soundless",
				title: "SoundLess",
				description:
					"Innowacyjna gra horror, w której gracze poruszają się w ciemności, korzystając z mechaniki echolokacji.",
				...
				links: [
					{
						name: "Dodaj do listy życzeń na Steam",
						url: "https://store.steampowered.com",
						description: "Dodaj naszą grę do listy życzeń już teraz!",
					},
				],
				thumbnail: {
					square: {
				...
				content: {
					about: [
						"SoundLess to unikalne doświadczenie horroru, które wyzwala graczy do poruszania się w całkowitej ciemności, używając tylko dźwięku.",
					],
					features: [
						"Innowacyjna mechanika rozgrywki oparta na echolokacji",
						"Niestandardowy system propagacji i odbicia dźwięku",
					],
				},
				details: {
					role: "Dyrektor Gry",
					timeline: "20.08.2024 - Obecnie",
					platform: "PC",
				},
			},
			{
				...
				title: "TinyBuddies",
				description:
					"Urocza gra mobilna inspirowana Tamagotchi, w której gracze opiekują się wirtualnymi zwierzakami.",
				...
				content: {
					about: [
						"TinyBuddies przywraca nostalgiczną radość opieki nad wirtualnymi zwierzakami z nowoczesnym twistem.",
					],
					features: [
						"Opieka nad zwierzakiem w czasie rzeczywistym",
						"Powiadomienia push",
						"Mini-gry i aktywności",
					],
				},
				details: {
					role: "Dyrektor Projektu",
					timeline: "12.03.2024 - Obecnie",
	...
	experience: {
		title: "Doświadczenie",
		subtitle:
			"Chronologiczna podróż przez moje doświadczenie zawodowe i edukację.",
		dateFormats: {
			short: "DD.MM.YYYY",
			medium: "MMM YYYY",
			long: "MMMM YYYY",
		...
		data: [
			{
				...
				endDate: "present",
				description:
					"Współzałożyłem i prowadzę studio tworzenia gier z zespołem ponad 10+ artystów i programistów",
				achievements: [
				...
				projects: [
					{
						name: "TinyBuddies",
						description:
							"Urocza gra mobilna, w której gracze opiekują się i wychowują unikalne wirtualne zwierzaki w przytulnym świecie pixel art. Posiada dynamiczne osobowości zwierząt, mini-gry i interakcje społeczne.",
						link: "",
					},
					{
						name: "SoundLess",
						description:
							"Innowacyjna gra horrorowa, w której gracze poruszają się w ciemności za pomocą mechaniki echolokacji. Zbudowana z niestandardowym systemem propagacji dźwięku i dynamicznymi interakcjami ze środowiskiem.",
						link: "",
					},
				],
			},
			{
				...
				endDate: "26/06/2023",
				description:
					"Tworzenie i utrzymywanie stron internetowych klientów przy użyciu WordPressa i nowoczesnych technologii webowych",
				achievements: [
	...
	home: {
		hero: {
			...
			roles: [
				...
				"Programista",
				"Twórca Gier",
				"Kontrybutor Open Source",
			],
			description:
				"Pasjonuję się tworzeniem kreatywnych rzeczy. Specjalizuję się w projektowaniu i tworzeniu UI/UX, a ostatnio jestem również twórcą gier.",
		},
		experience: {
			title: "Doświadczenie",
	...
	contact: {
		...
		header: {
			...
			description:
				"Porozmawiajmy o Twoim projekcie lub po prostu przywitaj się",
		},
		form: {
			title: "Wyślij wiadomość",
			sending: "Wysyłanie...",
			successMessage:
				"Wiadomość wysłana pomyślnie! Dziękuję {name}, wkrótce się odezwę.",
			errorMessage:
				"Nie udało się wysłać wiadomości. Spróbuj ponownie lub użyj innej metody kontaktu.",
			submit: "Wyślij wiadomość",
			recaptchaNotice:
				"Ta strona jest chroniona przez reCAPTCHA oraz Politykę prywatności i Warunki korzystania z usług Google.",
		...
		availability: {
			title: "Dostępność",
			description:
				"Obecnie dostępny dla nowych projektów i współpracy. Zazwyczaj odpowiadam w ciągu 24 godzin.",
		},
	},
	cv: {
		title: "Życiorys",
		...
		content: {
			...
			tools: ["Git i GitHub", "Figma", "Visual Studio Code"],
			languages: [
			...
			education: [
				{
					degree: "Uczeń",
					school: "Gimnazjum w Cedrach Wielkich",
					period: "2014–2018",
				},
			],
			summary:
			...
			gdprConsent:
				"Wyrażam zgodę na przetwarzanie moich danych osobowych w celach rekrutacyjnych zgodnie z ustawą o ochronie danych osobowych.",
		},
	},
	patrons: {
		title: "Patroni",
		description:
			"Dziękuję wszystkim, którzy wspierają moją pracę i pomagają mi tworzyć niesamowite projekty.",
		githubSponsors: {
			...
			emptyDescription:
				"Zostań pierwszym, który wesprze moją pracę open-source! Twoje sponsorowanie pomaga mi kontynuować tworzenie i utrzymywanie projektów.",
		},
		patreonSupporters: {
			...
			noSupporters:
				"Jeszcze nie ma wspierających Patreon. Dołącz do społeczności i wesprzyj moją pracę!",
		...
		cta: {
			...
			description:
				"Twoje wsparcie pomaga mi poświęcić więcej czasu na projekty open-source, tworzenie treści edukacyjnych i budowanie niesamowitych narzędzi dla społeczności.",
			githubSponsors: "GitHub Sponsors",
			patreon: "Patreon",
		},
	},
