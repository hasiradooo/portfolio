...
export default function StoryShell({ chapters, children }: { chapters: Chapter[]; children: ReactNode }) {
  ...
  return (
    <div lang="en" className={`${personal.world} ${autumn ? personal.autumn : ""} ${styles.world}`} data-personal-page data-personal-palette={autumn ? "autumn" : "blue"}>
      ...
      <ScrapbookBar href="/personal" backLabel="back to my world" address="home / kiro / notebook.html">
      ...
      <footer className={styles.footer}>some stories take time. thanks for being here. ♡ <Link href="/personal">back to the scrapbook <Icon name="arrow" /></Link></footer>
    </div>
  );
}
