...
export const metadata = storyMetadata("Meet the characters", "/personal/story/characters", "Kiro, Rin and Susie: character notes and little details from Kiro’s story by hasira.");
export default function CharactersPage() {
  return <>
    ...
    <div className={styles.actions}><Link className={styles.primary} href={chapterHref(chapters[0].slug)}>meet them in chapter one</Link><Link href="/personal/story">back to the notebook</Link></div>
  </>;
}
