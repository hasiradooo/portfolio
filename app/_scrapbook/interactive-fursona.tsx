...
const honkUrl =
	"https://www.myinstants.com/media/sounds/fnaf-12-3-freddys-nose-sound.mp3";

export default function InteractiveFursona({
	animated,
}: {
	animated: boolean;
}) {
	...
	function squeak() {
		...
		try {
			...
			/* The hosted clip can still play without Web Audio. */
		}
		const fallback = () => {
	...
	return (
		<div className={styles.portrait} data-petting={petting}>
			...
			<img
				...
				src="/story/characters/kiro-closed-eyes.png"
				alt=""
				aria-hidden="true"
				width="1280"
				height="999"
			...
			<button
				...
				type="button"
				aria-label="Boop Kiro’s nose (plays a squeak)"
				title="Boop!"
				onClick={squeak}
			/>
