...
import InteractiveFursona from "./interactive-fursona";
...
const extraGames = [
  {
    ...
    note: "just one more basement run.",
    rotation: "-3deg",
  },
  {
  ...
  },
  {
    ...
    note: "one more contract. maybe some gwent.",
    rotation: "4deg",
  },
] as const;
    ...
    >
      ...
      <div className={styles.canvas}>
        ...
        <div id="scrapbook" className={styles.board}>
          ...
          >
            <span className={styles.pin} aria-hidden="true" />
            <InteractiveFursona animated={animated} />
          ...
          >
            ...
            >
              <ul>
                ...
                <li>
                  <span>✦</span> astronomy, stars & the night sky
                </li>
                <li>
        ...
        >
          <header className={styles.sectionTitle}>
            ...
            <p>socials, little updates & a place to talk.</p>
          </header>
          <div className={styles.contactGrid}>
            <div className={styles.contactCard}>
              <span className={styles.smallLabel}>DISCORD / LET’S TALK</span>
              <strong>@hasiradoo</strong>
              <p>Add me by username on Discord.</p>
              <button
                type="button"
                onClick={async () => {
                  try {
                    await navigator.clipboard.writeText("hasiradoo");
                    setDiscordNotice("Copied!");
                  } catch {
                    setDiscordNotice("Select and copy @hasiradoo above.");
                  }
                }}
              >
                copy username <ScrapbookIcon name="arrow" />
              </button>
            ...
            <a
              ...
              rel="noopener noreferrer"
            >
              <span className={styles.smallLabel}>TWITTER / X</span>
              <strong>@hasiradoo</strong>
              <p>Posts, thoughts & things I like.</p>
              <span>
                visit my profile <ScrapbookIcon name="arrow" />
              </span>
            </a>
            <a
              className={styles.contactCard}
              href="https://bsky.app/profile/hasira.me"
              target="_blank"
              rel="noopener noreferrer"
            >
              <span className={styles.smallLabel}>BLUESKY</span>
              <strong>@hasira.me</strong>
              <p>A little more of me, over here.</p>
              <span>
                visit my profile <ScrapbookIcon name="arrow" />
              </span>
            </a>
            <a
              ...
              rel="noopener noreferrer"
            >
              <span className={styles.smallLabel}>TELEGRAM / SAY HI</span>
              <strong>@hasiradooo</strong>
              <p>Drop me a message.</p>
              <span>
                open Telegram <ScrapbookIcon name="arrow" />
              </span>
            </a>
          </div>
        </section>
        ...
        <footer className={styles.footer}>
          ...
          <div className={styles.footerLinks}>
            <a
              ...
              rel="noopener noreferrer"
            >
              say hi @hasiradoo <ScrapbookIcon name="arrow" />
            </a>
            <Link href="/story">
