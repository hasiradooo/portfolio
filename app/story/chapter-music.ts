...
export type ChapterTrack = { title: string; artist: string; youtubeUrl: string | null };
...
export function chapterTrack(slug: string): ChapterTrack {
  return (choices as Record<string, ChapterTrack>)[slug] ?? { title: '', artist: '', youtubeUrl: null };
}
