		...
		<>
			{navigationLinks.map((link) => {
				...
				return (
					...
					>
						{dict.common.nav[
							link.label.toLowerCase() as keyof typeof dict.common.nav
						] ?? link.label}
						<span
							className={cn(
								...
								isActive
									? "scale-x-100"
									: "scale-x-0 md:group-hover:scale-x-100",
							)}
						/>
					</Link>
				);
                  ...
                  >
                    {dict.common.nav.skipNavigation}
                      ...
                      {dict.common.siteName}
						...
						{isMobile ? (
							<MobileNav
								items={navigationLinks.map((n) => ({
									...n,
									label:
										dict.common.nav[
											n.label.toLowerCase() as keyof typeof dict.common.nav
										] ?? n.label,
								}))}
